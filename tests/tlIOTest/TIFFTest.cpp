...
namespace tl
{
    namespace io_tests
    {
        TIFFTest::TIFFTest(const std::shared_ptr<feather_tk::Context>& context) :
            ITest(context, "io_test::TIFFTest")
        {}

        std::shared_ptr<TIFFTest> TIFFTest::create(const std::shared_ptr<feather_tk::Context>& context)
        {
