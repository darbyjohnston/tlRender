...
namespace tl
{
    ...
    {
        MathTest::MathTest(const std::shared_ptr<dtk::Context>& context) :
            ITest(context, "core_tests::MathTest")
        {}

        std::shared_ptr<MathTest> MathTest::create(const std::shared_ptr<dtk::Context>& context)
        {
