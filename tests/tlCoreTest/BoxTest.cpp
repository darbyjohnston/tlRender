...
namespace tl
{
    namespace core_tests
    {
        ...
        void BoxTest::_intersections()
        {
            ...
            {
                TLRENDER_ASSERT(Box2f(0.F, 0.F, 1.F, 1.F).contains(Box2f(0.F, 0.F, 1.F, 1.F)));
                TLRENDER_ASSERT(!Box2f(0.F, 0.F, 1.F, 1.F).contains(Box2f(1.F, 1.F, 1.F, 1.F)));
                TLRENDER_ASSERT(!Box2f(0.F, 0.F, 1.F, 1.F).contains(Box2f(-1.F, -1.F, 1.F, 1.F)));
            }
            {
                TLRENDER_ASSERT(Box2i(0, 0, 1, 1).intersects(Box2i(0, 0, 1, 1)));
                TLRENDER_ASSERT(!Box2i(0, 0, 1, 1).intersects(Box2i(2, 2, 1, 1)));
                TLRENDER_ASSERT(!Box2i(0, 0, 1, 1).intersects(Box2i(-2, -2, 1, 1)));
            }
            {
                TLRENDER_ASSERT(Box2f(0.F, 0.F, 1.F, 1.F).intersects(Box2f(0.F, 0.F, 1.F, 1.F)));
                TLRENDER_ASSERT(!Box2f(0.F, 0.F, 1.F, 1.F).intersects(Box2f(2.F, 2.F, 1.F, 1.F)));
                TLRENDER_ASSERT(!Box2f(0.F, 0.F, 1.F, 1.F).intersects(Box2f(-2.F, -2.F, 1.F, 1.F)));
            }
            {
                TLRENDER_ASSERT(Box2i(0, 0, 1, 1).intersect(Box2i(0, 0, 1, 1)) == Box2i(0, 0, 1, 1));
                TLRENDER_ASSERT(Box2i(0, 0, 1, 1).intersect(Box2i(-1, -1, 2, 2)) == Box2i(0, 0, 1, 1));
                TLRENDER_ASSERT(!Box2i(Box2i(0, 0, 1, 1).intersect(Box2i(2, 2, 1, 1))).isValid());
                TLRENDER_ASSERT(!Box2i(Box2i(0, 0, 1, 1).intersect(Box2i(-2, -2, 1, 1))).isValid());
            }
            {
                TLRENDER_ASSERT(Box2f(0.F, 0.F, 1.F, 1.F).intersect(Box2f(0.F, 0.F, 1.F, 1.F)) == Box2f(0.F, 0.F, 1.F, 1.F));
                TLRENDER_ASSERT(Box2f(0.F, 0.F, 1.F, 1.F).intersect(Box2f(-1.F, -1.F, 2.F, 2.F)) == Box2f(0.F, 0.F, 1.F, 1.F));
                TLRENDER_ASSERT(!Box2f(Box2f(0.F, 0.F, 1.F, 1.F).intersect(Box2f(2.F, 2.F, 1.F, 1.F))).isValid());
                TLRENDER_ASSERT(!Box2f(Box2f(0.F, 0.F, 1.F, 1.F).intersect(Box2f(-2.F, -2.F, 1.F, 1.F))).isValid());
            }
        }
        ...
        {
            {
                TLRENDER_ASSERT(Box2i(0, 1, 2, 3).margin(Vector2i(1, 2)) == Box2i(-1, -1, 4, 7));
                TLRENDER_ASSERT(Box2f(0.F, 1.F, 2.F, 3.F).margin(Vector2f(1.F, 2.F)) == Box2f(-1.F, -1.F, 4.F, 7.F));
            }
            {
                TLRENDER_ASSERT(Box2i(0, 1, 2, 3).margin(1) == Box2i(-1, 0, 4, 5));
                TLRENDER_ASSERT(Box2f(0.F, 1.F, 2.F, 3.F).margin(1.F) == Box2f(-1.F, 0.F, 4.F, 5.F));
            }
            {
                const auto b = Box2i(0, 1, 2, 3).margin(1, 2, 3, 4);
                TLRENDER_ASSERT(Box2i(0, 1, 2, 3).margin(1, 2, 3, 4) == Box2i(-1, -1, 6, 9));
                const auto b2 = Box2f(0.F, 1.F, 2.F, 3.F).margin(1.F, 2.F, 3.F, 4.F);
                TLRENDER_ASSERT(Box2f(0.F, 1.F, 2.F, 3.F).margin(1.F, 2.F, 3.F, 4.F) == Box2f(-1.F, -1.F, 6.F, 9.F));
            }
        }
