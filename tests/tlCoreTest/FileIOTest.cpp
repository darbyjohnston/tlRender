...
namespace tl
{
    namespace tests
    {
        namespace core_test
        {
            FileIOTest::FileIOTest(const std::shared_ptr<core::Context>& context) :
                ITest("core_test::FileIOTest", context),
                _fileName("file.txt"),
                _text("Hello"),
                _text2("world!")
            {}

            std::shared_ptr<FileIOTest> FileIOTest::create(const std::shared_ptr<core::Context>& context)
            {
