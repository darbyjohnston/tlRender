            ...
            if (window)
            {
                ...
                try
                {
                    ...
                    shader->setUniform(
                        ...
                        1);
                    shader->setUniform(
                        glGetUniformLocation(shader->getProgram(), "floatValue"),
                        1.F);
                    shader->setUniform(
                    ...
                    shader->setUniform(
                        glGetUniformLocation(shader->getProgram(), "floatArray"),
                    ...
                    shader->setUniform("vec2Value", math::Vector2f(1.0, 2.0));
                    shader->setUniform("vec3Value", math::Vector3f(1.0, 2.0, 3.0));
