...
namespace tl
{
    namespace gl_tests
    {
        TextureTest::TextureTest(const std::shared_ptr<dtk::Context>& context) :
            ITest(context, "gl_tests::TextureTest")
        {}

        std::shared_ptr<TextureTest> TextureTest::create(const std::shared_ptr<dtk::Context>& context)
        {
