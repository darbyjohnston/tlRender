...
namespace tlr
{
    namespace CoreTest
    {
        ...
        void ImageTest::_size()
        {
            ...
            {
                TLR_ASSERT(math::BBox2i(0, 0, 100, 100) == getBBox(1.F, math::BBox2i(0, 0, 100, 100)));
                TLR_ASSERT(math::BBox2i(50, 0, 100, 100) == getBBox(1.F, math::BBox2i(0, 0, 200, 100)));
                TLR_ASSERT(math::BBox2i(0, 50, 100, 100) == getBBox(1.F, math::BBox2i(0, 0, 100, 200)));
            }
        }
