...
namespace tl
{
    namespace play_qt
    {
            ...
            _p(new Private)
        {
            ...
            connect(
                this,
                &TimelineViewport::droppedFramesChanged,
                [this](size_t value)
                {
        ...
        void Viewport::paintGL()
        {
            ...
            if (p.hud)
            {
                ...
                for (const auto& text : p.text)
                {
                    ...
                    painter.fillRect(g3.min.x, g3.min.y, g3.w(), g3.h(), QColor(0, 0, 0, 127));
                    painter.drawText(g3.min.x + margin, g3.min.y + margin + fm.ascent(), qtext);
                }
            }
        }
