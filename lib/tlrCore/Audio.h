...
namespace tlr
{
    ...
    namespace audio
    {
        ...
        constexpr void S8ToS16(S8_T, S16_T&) noexcept;
        constexpr void S8ToS32(S8_T, S32_T&) noexcept;
        constexpr void S8ToF32(S8_T, F32_T&) noexcept;
        constexpr void S8ToF64(S8_T, F64_T&) noexcept;

        constexpr void S16ToS8(S16_T, S8_T&) noexcept;
        constexpr void S16ToS32(S16_T, S32_T&) noexcept;
        constexpr void S16ToF32(S16_T, F32_T&) noexcept;
        constexpr void S16ToF64(S16_T, F64_T&) noexcept;

        constexpr void S32ToS8(S32_T, S8_T&) noexcept;
        constexpr void S32ToS16(S32_T, S16_T&) noexcept;
        constexpr void S32ToF32(S32_T, F32_T&) noexcept;
        constexpr void S32ToF64(S32_T, F64_T&) noexcept;

        constexpr void F32ToS8(F32_T, S8_T&) noexcept;
        constexpr void F32ToS16(F32_T, S16_T&) noexcept;
        constexpr void F32ToS32(F32_T, S32_T&) noexcept;
        constexpr void F32ToF64(F32_T, F64_T&) noexcept;

        constexpr void F64ToS8(F64_T, S8_T&) noexcept;
        constexpr void F64ToS16(F64_T, S16_T&) noexcept;
        constexpr void F64ToS32(F64_T, S32_T&) noexcept;
        constexpr void F64ToF32(F64_T, F32_T&) noexcept;
