    ...
    namespace gl
    {
        ...
        namespace
        {
            ...
            const std::string fragmentSource =
                ...
                "    {\n"
                "        float y = texture(s0, fTexture).r - (16.0/256.0);\n"
                "        float u = texture(s1, fTexture).r - (128.0/256.0);\n"
                "        float v = texture(s2, fTexture).r - (128.0/256.0);\n"
                "        c.r = (298.0/256.0*y) + (409.0/256.0*v) + (128.0/256.0);\n"
                "        c.g = (298.0/256.0*y) - (100.0/256.0*u) - (208.0/256.0*v);\n"
                "        c.b = (298.0/256.0*y) + 1.772 * u;\n"
                "        c.a = 1.0;\n"
                "    }\n"
                "    else\n"
                "    {\n"
