...
namespace tl
{
    namespace play
    {
            ...
            _p(new Private)
        {
            ...
            p.actions["Channels/Red"]->setData(QVariant::fromValue<render::Channels>(render::Channels::Red));
            ...
            p.actions["Channels/Green"]->setData(QVariant::fromValue<render::Channels>(render::Channels::Green));
            ...
            p.actions["Channels/Blue"]->setData(QVariant::fromValue<render::Channels>(render::Channels::Blue));
            ...
            p.actions["Channels/Alpha"]->setData(QVariant::fromValue<render::Channels>(render::Channels::Alpha));
            ...
            p.actions["YUVRange/FromFile"]->setData(QVariant::fromValue<render::YUVRange>(render::YUVRange::FromFile));
            ...
            p.actions["YUVRange/Full"]->setData(QVariant::fromValue<render::YUVRange>(render::YUVRange::Full));
            ...
            p.actions["YUVRange/Video"]->setData(QVariant::fromValue<render::YUVRange>(render::YUVRange::Video));
            ...
            p.actions["AlphaBlend/None"]->setData(QVariant::fromValue<render::AlphaBlend>(render::AlphaBlend::None));
            ...
            p.actions["AlphaBlend/Straight"]->setData(QVariant::fromValue<render::AlphaBlend>(render::AlphaBlend::Straight));
            ...
            p.actions["AlphaBlend/Premultiplied"]->setData(QVariant::fromValue<render::AlphaBlend>(render::AlphaBlend::Premultiplied));
        ...
        void ImageActions::setImageOptions(const render::ImageOptions& value)
        {
            TLRENDER_P();
