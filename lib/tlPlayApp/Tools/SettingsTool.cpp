    ...
    namespace play
    {
            ...
            const std::shared_ptr<IWidget>& parent)
        {
            ...
            p.sizeGB->setCallback(
                ...
                {
                    DTK_P();
                    CacheOptions cache = p.model->getCache();
                    cache.sizeGB = value;
        ...
        struct FileSequenceSettingsWidget::Private
        {
            ...
            std::shared_ptr<dtk::ValueObserver<FileSequenceOptions> > fileSequenceObserver;
            ...
            const std::shared_ptr<IWidget>& parent)
        {
            ...
            p.fileSequenceObserver = dtk::ValueObserver<FileSequenceOptions>::create(
            ...
            p.audioComboBox->setIndexCallback(
                ...
                {
                    DTK_P();
                    FileSequenceOptions fileSequence = p.model->getFileSequence();
        ...
        struct PerformanceSettingsWidget::Private
        {
            ...
            std::shared_ptr<dtk::ValueObserver<PerformanceOptions> > performanceObserver;
        };
            ...
            const std::shared_ptr<IWidget>& parent)
        {
            ...
            p.performanceObserver = dtk::ValueObserver<PerformanceOptions>::create(
