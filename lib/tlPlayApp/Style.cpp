...
namespace tl
{
    namespace play_app
    {
        ...
        std::map<ui::ColorRole, image::Color4f> getStylePalette(StylePalette value)
        {
            ...
            case StylePalette::Light:
                ...
                out[ui::ColorRole::TextDisabled] = image::Color4f(.5F, .5F, .5F);
                out[ui::ColorRole::Border] = image::Color4f(.6F, .6F, .6F);
                out[ui::ColorRole::Hover] = image::Color4f(0.F, 0.F, 0.F, .1F);
                out[ui::ColorRole::Pressed] = image::Color4f(0.F, 0.F, 0.F, .2F);
