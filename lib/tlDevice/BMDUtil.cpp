            ...
            case PixelType::_12BitRGB:
                for (int y = 0; y < size.h; ++y)
                {
                    ...
                    for (int x = 0; x < size.w; x += 8)
                    {
                        ...
                        out8[0 + (3 - 0)] = r12 & 0xFF;
                        out8[0 + (3 - 1)] = (r12 >> 8) & 0x0F;
                        out8[0 + (3 - 1)] |= (g12 & 0x0F) << 4;
                        out8[0 + (3 - 2)] = (g12 >> 4) & 0xFF;
                        out8[0 + (3 - 3)] = b12 & 0xFF;
                        out8[4 + (3 - 0)] = (b12 >> 8) & 0x0F;

                        r12 = in16[3] >> 4;
                        g12 = in16[4] >> 4;
                        b12 = in16[5] >> 4;
                        out8[4 + (3 - 0)] |= (r12 & 0x0F) << 4;
                        out8[4 + (3 - 1)] = (r12 >> 4) & 0xFF;
                        out8[4 + (3 - 2)] = g12 & 0xFF;
                        out8[4 + (3 - 3)] = (g12 >> 8) & 0x0F;
                        out8[4 + (3 - 3)] |= (b12 & 0x0F) << 4;
                        out8[8 + (3 - 0)] = (b12 >> 4) & 0xFF;

                        r12 = in16[6] >> 4;
                        g12 = in16[7] >> 4;
                        b12 = in16[8] >> 4;
                        out8[8 + (3 - 1)] = r12 & 0xFF;
                        out8[8 + (3 - 2)] = (r12 >> 8) & 0x0F;
                        out8[8 + (3 - 2)] |= (g12 & 0x0F) << 4;
                        out8[8 + (3 - 3)] = (g12 >> 4) & 0xFF;
                        out8[12 + (3 - 0)] = b12 & 0xFF;
                        out8[12 + (3 - 1)] = (b12 >> 8) & 0x0F;

                        r12 = in16[9] >> 4;
                        g12 = in16[10] >> 4;
                        b12 = in16[11] >> 4;
                        out8[12 + (3 - 1)] |= (r12 & 0x0F) << 4;
                        out8[12 + (3 - 2)] = (r12 >> 4) & 0xFF;
                        out8[12 + (3 - 3)] = g12 & 0xFF;
                        out8[16 + (3 - 0)] = (g12 >> 8) & 0x0F;
                        out8[16 + (3 - 0)] |= (b12 & 0x0F) << 4;
                        out8[16 + (3 - 1)] = (b12 >> 4) & 0xFF;

                        r12 = in16[12] >> 4;
                        g12 = in16[13] >> 4;
                        b12 = in16[14] >> 4;
                        out8[16 + (3 - 2)] = r12 & 0xFF;
                        out8[16 + (3 - 3)] = (r12 >> 8) & 0x0F;
                        out8[16 + (3 - 3)] |= (g12 & 0x0F) << 4;
                        out8[20 + (3 - 0)] = (g12 >> 4) & 0xFF;
                        out8[20 + (3 - 1)] = b12 & 0xFF;
                        out8[20 + (3 - 2)] = (b12 >> 8) & 0x0F;

                        r12 = in16[15] >> 4;
                        g12 = in16[16] >> 4;
                        b12 = in16[17] >> 4;
                        out8[20 + (3 - 2)] |= (r12 & 0x0F) << 4;
                        out8[20 + (3 - 3)] = (r12 >> 4) & 0xFF;
                        out8[24 + (3 - 0)] = g12 & 0xFF;
                        out8[24 + (3 - 1)] = (g12 >> 8) & 0x0F;
                        out8[24 + (3 - 1)] |= (b12 & 0x0F) << 4;
                        out8[24 + (3 - 2)] = (b12 >> 4) & 0xFF;

                        r12 = in16[18] >> 4;
                        g12 = in16[19] >> 4;
                        b12 = in16[20] >> 4;
                        out8[24 + (3 - 3)] = r12 & 0xFF;
                        out8[28 + (3 - 0)] = (r12 >> 8) & 0x0F;
                        out8[28 + (3 - 0)] |= (g12 & 0x0F) << 4;
                        out8[28 + (3 - 1)] = (g12 >> 4) & 0xFF;
                        out8[28 + (3 - 2)] = b12 & 0xFF;
                        out8[28 + (3 - 3)] = (b12 >> 8) & 0x0F;

                        r12 = in16[21] >> 4;
                        g12 = in16[22] >> 4;
                        b12 = in16[23] >> 4;
                        out8[28 + (3 - 3)] |= (r12 & 0x0F) << 4;
                        out8[32 + (3 - 0)] = (r12 >> 4) & 0xFF;
                        out8[32 + (3 - 1)] = g12 & 0xFF;
                        out8[32 + (3 - 2)] = (g12 >> 8) & 0x0F;
                        out8[32 + (3 - 2)] |= (b12 & 0x0F) << 4;
                        out8[32 + (3 - 3)] = (b12 >> 4) & 0xFF;
            ...
            case PixelType::_12BitRGBLE:
                for (int y = 0; y < size.h; ++y)
                {
                    ...
                    for (int x = 0; x < size.w; x += 8)
                    {
                        ...
                        out8[8 + 3] = (g12 >> 4) & 0xFF;
                        out8[12 + 0] = b12 & 0xFF;
                        out8[12 + 1] = (b12 >> 8) & 0x0F;

                        r12 = in16[9] >> 4;
                        g12 = in16[10] >> 4;
                        b12 = in16[11] >> 4;
                        out8[12 + 1] |= (r12 & 0x0F) << 4;
                        out8[12 + 2] = (r12 >> 4) & 0xFF;
                        out8[12 + 3] = g12 & 0xFF;
                        out8[16 + 0] = (g12 >> 8) & 0x0F;
                        out8[16 + 0] |= (b12 & 0x0F) << 4;
                        out8[16 + 1] = (b12 >> 4) & 0xFF;

                        r12 = in16[12] >> 4;
                        g12 = in16[13] >> 4;
                        b12 = in16[14] >> 4;
                        out8[16 + 2] = r12 & 0xFF;
                        out8[16 + 3] = (r12 >> 8) & 0x0F;
                        out8[16 + 3] |= (g12 & 0x0F) << 4;
                        out8[20 + 0] = (g12 >> 4) & 0xFF;
                        out8[20 + 1] = b12 & 0xFF;
                        out8[20 + 2] = (b12 >> 8) & 0x0F;

                        r12 = in16[15] >> 4;
                        g12 = in16[16] >> 4;
                        b12 = in16[17] >> 4;
                        out8[20 + 2] |= (r12 & 0x0F) << 4;
                        out8[20 + 3] = (r12 >> 4) & 0xFF;
                        out8[24 + 0] = g12 & 0xFF;
                        out8[24 + 1] = (g12 >> 8) & 0x0F;
                        out8[24 + 1] |= (b12 & 0x0F) << 4;
                        out8[24 + 2] = (b12 >> 4) & 0xFF;

                        r12 = in16[18] >> 4;
                        g12 = in16[19] >> 4;
                        b12 = in16[20] >> 4;
                        out8[24 + 3] = r12 & 0xFF;
                        out8[28 + 0] = (r12 >> 8) & 0x0F;
                        out8[28 + 0] |= (g12 & 0x0F) << 4;
                        out8[28 + 1] = (g12 >> 4) & 0xFF;
                        out8[28 + 2] = b12 & 0xFF;
                        out8[28 + 3] = (b12 >> 8) & 0x0F;

                        r12 = in16[21] >> 4;
                        g12 = in16[22] >> 4;
                        b12 = in16[23] >> 4;
                        out8[28 + 3] |= (r12 & 0x0F) << 4;
                        out8[32 + 0] = (r12 >> 4) & 0xFF;
                        out8[32 + 1] = g12 & 0xFF;
                        out8[32 + 2] = (g12 >> 8) & 0x0F;
                        out8[32 + 2] |= (b12 & 0x0F) << 4;
                        out8[32 + 3] = (b12 >> 4) & 0xFF;
