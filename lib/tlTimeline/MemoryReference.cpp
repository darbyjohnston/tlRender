...
namespace tl
{
    namespace timeline
    {
        ...
        const std::shared_ptr<ftk::FileIO>& ZipMemoryReference::file_io() const noexcept
        {
            return _file_io;
        }

        void ZipMemoryReference::set_file_io(const std::shared_ptr<ftk::FileIO>& file_io)
        {
            _file_io = file_io;
        }
        ...
        const std::shared_ptr<ftk::FileIO>& ZipMemorySequenceReference::file_io() const noexcept
        {
            return _file_io;
        }

        void ZipMemorySequenceReference::set_file_io(const std::shared_ptr<ftk::FileIO>&file_io)
        {
            _file_io = file_io;
        }
    }
