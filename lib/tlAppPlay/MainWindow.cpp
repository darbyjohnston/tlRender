    ...
    namespace app
    {
        namespace play
        {
            ...
            struct MainWindow::Private
            {
                ...
                qt::widget::TimelineViewport* timelineViewport = nullptr;
                qt::widget::TimelineSlider* timelineSlider = nullptr;
                qt::widget::TimeSpinBox* currentTimeSpinBox = nullptr;
                qt::widget::TimeLabel* durationLabel = nullptr;
                ...
                _p(new Private)
            {
                ...
                topToolBar->addWidget(new qt::widget::Spacer(Qt::Horizontal));
                topToolBar->addWidget(new qt::widget::Spacer(Qt::Horizontal));
                ...
                p.timelineViewport = new qt::widget::TimelineViewport(app->getContext());
                p.timelineViewport->installEventFilter(this);
                setCentralWidget(p.timelineViewport);

                p.timelineSlider = new qt::widget::TimelineSlider(app->getContext());
                ...
                bottomToolBar->addWidget(new qt::widget::Spacer(Qt::Horizontal));
                bottomToolBar->addWidget(new qt::widget::Spacer(Qt::Horizontal));
                ...
                connect(
                    ...
                    &qt::widget::TimeSpinBox::valueChanged,
