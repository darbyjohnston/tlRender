...
namespace tl
{
    namespace app
    {
        namespace play
        {
            ...
            {
                core::file::Path path;
                core::file::Path audioPath;

                bool init = false;

                otime::RationalTime duration = core::time::invalidTime;
                otime::RationalTime globalStartTime = core::time::invalidTime;
                io::Info ioInfo;

                double speed = 0.0;
                timeline::Playback playback = timeline::Playback::Stop;
                timeline::Loop loop = timeline::Loop::Loop;
                otime::RationalTime currentTime = core::time::invalidTime;
                otime::TimeRange inOutRange = core::time::invalidTimeRange;
            ...
            public:
                ...
                //! Observe the A file.
                std::shared_ptr<core::observer::IValue<std::shared_ptr<FilesModelItem> > > observeA() const;

                //! Observe the A file index.
                std::shared_ptr<core::observer::IValue<int> > observeAIndex() const;

                //! Observe the B files.
                std::shared_ptr<core::observer::IList<std::shared_ptr<FilesModelItem> > > observeB() const;

                //! Observe the B file indexes.
                std::shared_ptr<core::observer::IList<int> > observeBIndexes() const;

                //! Observe the active files.
                std::shared_ptr<core::observer::IList<std::shared_ptr<FilesModelItem> > > observeActive() const;
                ...
                //! Observe the layers.
                std::shared_ptr<core::observer::IList<int> > observeLayers() const;
                ...
                std::shared_ptr<core::observer::IValue<timeline::CompareOptions> > observeCompareOptions() const;
