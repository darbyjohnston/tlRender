    ...
    namespace app
    {
        namespace play
        {
            ...
            struct ColorWidget::Private
            {
                ...
                qt::widget::FloatSlider* addSlider = nullptr;
                qt::widget::FloatSlider* brightnessSlider = nullptr;
                qt::widget::FloatSlider* contrastSlider = nullptr;
                qt::widget::FloatSlider* saturationSlider = nullptr;
                qt::widget::FloatSlider* tintSlider = nullptr;
            ...
            struct LevelsWidget::Private
            {
                ...
                qt::widget::FloatSlider* inLowSlider = nullptr;
                qt::widget::FloatSlider* inHighSlider = nullptr;
                qt::widget::FloatSlider* gammaSlider = nullptr;
                qt::widget::FloatSlider* outLowSlider = nullptr;
                qt::widget::FloatSlider* outHighSlider = nullptr;
            };
                ...
                _p(new Private)
            {
                ...
                p.inLowSlider = new qt::widget::FloatSlider;
                p.inLowSlider->setDefaultValue(0.F);

                p.inHighSlider = new qt::widget::FloatSlider;
                p.inHighSlider->setDefaultValue(1.F);

                p.gammaSlider = new qt::widget::FloatSlider;
                p.gammaSlider->setRange(math::FloatRange(.1F, 4.F));
                p.gammaSlider->setDefaultValue(1.F);

                p.outLowSlider = new qt::widget::FloatSlider;
                p.outLowSlider->setDefaultValue(0.F);

                p.outHighSlider = new qt::widget::FloatSlider;
            ...
            struct ExposureWidget::Private
            {
                ...
                qt::widget::FloatSlider* exposureSlider = nullptr;
                qt::widget::FloatSlider* defogSlider = nullptr;
                qt::widget::FloatSlider* kneeLowSlider = nullptr;
                qt::widget::FloatSlider* kneeHighSlider = nullptr;
            };
            ...
            struct SoftClipWidget::Private
            {
                ...
                qt::widget::FloatSlider* softClipSlider = nullptr;
            };
                ...
                _p(new Private)
            {
                ...
                p.softClipSlider = new qt::widget::FloatSlider;
