...
namespace tl
{
    namespace io
    {
        namespace cineon
        {
            ...
            Header read(const std::shared_ptr<file::FileIO>& io, Info& info)
            {
                Header out;
            ...
            void write(const std::shared_ptr<file::FileIO>& io, const Info& info)
            {
                Header header;
            ...
            void Plugin::_init(const std::weak_ptr<core::LogSystem>& logSystem)
            {
                IPlugin::_init(
                    "Cineon",
                    { { ".cin", FileExtensionType::VideoOnly } },
                    logSystem);
            }
