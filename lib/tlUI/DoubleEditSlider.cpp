...
namespace tl
{
    namespace ui
    {
        ...
        const dtk::RangeD& DoubleEditSlider::getRange() const
        {
            return _p->model->getRange();
        }

        void DoubleEditSlider::setRange(const dtk::RangeD& value)
        {
        ...
        void DoubleEditSlider::setGeometry(const dtk::Box2I& value)
        {
