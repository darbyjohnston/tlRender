...
if(CMAKE_OSX_DEPLOYMENT_TARGET)
    ...
    list(APPEND USD_ARGS USD,"-DPXR_INSTALL_LOCATION=../Plugins/usd -DCMAKE_OSX_DEPLOYMENT_TARGET=${CMAKE_OSX_DEPLOYMENT_TARGET}")
    ...
    list(APPEND USD_ARGS oneTBB,"-DCMAKE_CXX_OSX_DEPLOYMENT_TARGET_FLAG=-mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET} -DCMAKE_C_OSX_DEPLOYMENT_TARGET_FLAG=-mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}")
endif()
